                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <form method="POST" action="{{ route('saveQuestion') }}">
                        ...
                        <div>
                            ...
                            <input type="text" id="option1" class="block mt-1 w-full" name="option1" required autofocus>
                        </div> <!-- option 2  -->
                        <div>
                            <x-label for="option2" :value="__('Option2')" />
                            <input type="text" id="option2" class="block mt-1 w-full" name="option2" required autofocus>
                        </div> <!-- option 3  -->
                        <div>
                            <x-label for="option3" :value="__('Option3')" />
                            <input type="text" id="option3" class="block mt-1 w-full" name="option3" required autofocus>
                        </div> <!-- option 4  -->
                        <div>
                            <x-label for="option4" :value="__('Option4 ')" />
                            <input type="text" id="option4" class="block mt-1 w-full" name="option4" required autofocus>
                        </div>
                        ...
                        <div>
                            ...
                            <select class="custom-select" name="subject_id" id="subject_id">
                                ...
                                <option value="{{ $subject->id }}">{{ $subject->id }}-{{ $subject->name }}
                                </option>
                                @endforeach
                                @endisset
                            </select>
