                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input wire:model='fullName' type="text"  class="form-control"
                                        ...
                                        @error('fullName') <small class="text-dange"></small>@enderror
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label>Phone Number</label>
                                    <input wire:model='phoneNumber' type="number"  class="form-control"
                                    ...
                                    <div class="d-md-flex align-items-start">
                                        ...
                                        <div class="tab-content col-md-9" id="v-pills-tabContent">
                                            <div class="tab-pane fade active show" id="cashOnDeliveryTab" role="tabpanel"
                                                ...
                                                <hr />
                                                <button wire:click='codOrder' type="button" class="btn btn-primary">Place Order
